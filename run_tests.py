...
def run_all_tests():
    ...
    article_test_methods = [
        ...
        (
            article_tests.test_article_with_optional_fields,
    ...
    classifier_test_methods = [
        (
            classifier_tests.test_classify_startup_category,
            "test_classify_startup_category",
        ),
        (
            classifier_tests.test_classify_policy_category,
            "test_classify_policy_category",
        ),
        (classifier_tests.test_classify_country, "test_classify_country"),
        (
            classifier_tests.test_classify_default_category_no_tech_relevance,
            "test_classify_default_category_no_tech_relevance",
        ),
    ]
    ...
    scorer_test_methods = [
        (
            scorer_tests.test_quality_score_short_content,
            "test_quality_score_short_content",
        ),
        (
            scorer_tests.test_quality_score_good_content,
